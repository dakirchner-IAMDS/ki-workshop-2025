...
/**
 * Function registry type - maps function names to implementations
 */
...
/**
 * Evaluator class - evaluates AST nodes to compute results
 */
export class Evaluator {
  private functions: FunctionRegistry;

  /**
   * Create an evaluator with an optional function registry
   */
